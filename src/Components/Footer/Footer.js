...
const Footer = () => {
	return (
		...
		<address className='text-left md:text-center'>
			<p className='text-lg'>Shona Plaza 1st Floor</p>
			<p className='text-lg'>Police lines SP park</p>
			<p className='text-lg'>Tangail - 1900</p>
			<p className='text-lg'><span className='font-semibold'>Email:</span> info@admin.com</p>
		</address>
		<div>
