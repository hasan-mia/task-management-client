...
const Footer = () => {
	return (
		<footer className="footer px-4 lg:px-10 py-10 bg-black-400 text-base-content flex flex-wrap justify-between">
		<div>
			...
			<p>Md Hasan Mia.<br/>All right reserved &copy; 2022</p>
		</div>
		<address className='text-left md:text-center'>
			<p className='text-lg'>Shona Plaza 1st Floor, Police</p>
